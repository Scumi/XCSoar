...
\item[Setup Plane]  Easy reconfiguration of the plane-dependent settings (e.g. 
  ...
  plane profiles.
\item[Data Management] Provides file downloads, import, backup and flight
  export.  The Export Flights list scans IGC files in the background and adds
  detected takeoff, landing and duration information as it becomes available.
\end{description}
...
\begin{itemize}
\item[\raisebox{-1em}
{\includegraphics[angle=0,width=0.1\linewidth,keepaspectratio='true']{figures/gesture_du.pdf}}] DU, denoting a check mark: Show main menu 
\item[\raisebox{-1em}
{\includegraphics[angle=0,width=0.1\linewidth,keepaspectratio='true']{figures/gesture_up.pdf}}] U: Zoom in 
\item[\raisebox{-1em}
{\includegraphics[angle=0,width=0.1\linewidth,keepaspectratio='true']{figures/gesture_down.pdf}}] D: Zoom out 
\item[\raisebox{-1em}
{\includegraphics[angle=0,width=0.1\linewidth,keepaspectratio='true']{figures/gesture_left.pdf}}] L: Turn screen page pro-grade (Normal, Aux., Full-screen...) 
\item[\raisebox{-1em}
...
\begin{itemize}
\item[\raisebox{-1em}
{\includegraphics[angle=0,width=0.1\linewidth,keepaspectratio='true']{figures/gesture_dr.pdf}}] DR, denoting an L: Show the Select Waypoint dialogue similar to menu 
item Waypoint \textbf{L}ist
\item[\raisebox{-1em}
{\includegraphics[angle=0,width=0.1\linewidth,keepaspectratio='true']{figures/gesture_rd.pdf}}] RD, denoting a T: opens the \textbf{T}ask Manager
\item[\raisebox{-1em}
{\includegraphics[angle=0,width=0.1\linewidth,keepaspectratio='true']{figures/gesture_dl.pdf}}] DL: show the Alternates List
\item[\raisebox{-1em}
{\includegraphics[angle=0,width=0.1\linewidth,keepaspectratio='true']{figures/gesture_ud.pdf}}] UD: enables Auto-Zoom
\item[\raisebox{-1em}
{\includegraphics[angle=0,width=0.1\linewidth,keepaspectratio='true']{figures/gesture_uldr.pdf}}] ULDR: opens the Quick Menu
\end{itemize}
\vspace{2em}
...
\begin{itemize}
\item[\raisebox{-1em}
{\includegraphics[angle=0,width=0.1\linewidth,keepaspectratio='true']{figures/gesture_ldr.pdf}}] LDR, denoting a C: Show the \textbf{C}hecklist.

\item[\raisebox{-1em}
{\includegraphics[angle=0,width=0.1\linewidth,keepaspectratio='true']{figures/gesture_urd.pdf}}] URD, denoting an A: Show the \textbf{A}nalysis dialogue.
\item[\raisebox{-1em}
{\includegraphics[angle=0,width=0.1\linewidth,keepaspectratio='true']{figures/gesture_ldrdl.pdf}}] LDRDL, denoting an S: Open the \textbf{S}tatus dialogue
\end{itemize}
